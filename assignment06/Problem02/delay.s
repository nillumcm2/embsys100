...
delay
    ...
    CMP R0, #0 //compares the values to 0
    BEQ hold1 // if it value is walue is go to hold1
    SUBS R0, R0, #1 // subtract 1 from the value
    B delay // call delay with the new value
    BX LR               // return    
hold1
